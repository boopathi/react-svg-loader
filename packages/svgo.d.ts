// Copy of SVGO because typescript was annoying
// complaining falsely about esModuleInterop even though
// it was set to true
...
// FIXME: The part that's changed from the original implementation
declare module "svgo" {
  export default SVGO;
}
